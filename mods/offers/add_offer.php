...
if ($CURUSER['class'] < $INSTALLER09['offer_min_class']) {
    ...
    /////////////////////// HTML OUTPUT //////////////////////////////
    print stdhead('Offers Page').$HTMLOUT.stdfoot();
    die();
}
...
$HTMLOUT .= 'To make an offer you must have a ratio of at least<b> '.$INSTALLER09['offer_min_ratio'].'</b> AND have uploaded at least <b>'.$INSTALLER09['offer_gigs_upped'].' GB</b>.<br />'.
($INSTALLER09['karma'] ? " A offer will also cost you <b><a class='altlink' href='mybonus.php'>".$INSTALLER09['offer_cost_bonus']." Karma Points</a></b>....<br /><br />" :'')." 
...
elseif ($ratio < $INSTALLER09['offer_min_ratio'] && $CURUSER['class'] < UC_VIP) {
	    ...
	    $HTMLOUT .=
	     ...
	     " fail$sss to meet the minimum requirements. to Make a Offer.<br /><br />
