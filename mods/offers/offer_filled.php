...
$res = mysql_query("SELECT `userid` FROM `voted_offers` WHERE `offerid` = $id AND userid != $arr[userid]") or sqlerr(__FILE__, __LINE__);
...
if (mysql_num_rows($res) > 0) {
    ...
    $pn_msg     = sqlesc("The Offer you voted for [b]".$arr['offer']."[/b] has been accepted by [b]".
    $CURUSER['username']."[/b]. You can download your offer from 
...
/////////////////////// HTML OUTPUT //////////////////////////////
print stdhead('Offer Filled').$HTMLOUT.stdfoot();
?>