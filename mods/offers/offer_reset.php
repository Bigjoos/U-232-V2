...
"<p align='center'>Offer $id (".htmlspecialchars($arr['offer']).") successfully reset.</p>
...
"Sorry, cannot reset a offer when you are not the owner, staff or person filling it.<br /><br /></td></tr>
</table>";
}
...
/////////////////////// HTML OUTPUT //////////////////////////////
print stdhead('Reset Offer').$HTMLOUT.stdfoot();
?>