...
'upload_cover' => "Cover file(s)",
'upload_cover_add' => "Add more",
'upload_cover_info' => "Please select at least one picture !<b> Note that the upload process will be a lil slower</b>",
