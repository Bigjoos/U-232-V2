...
$select_torrent = sql_query('SELECT name, descr, category, visible, vip, release_group, poster, url, newgenre, anonymous, sticky, owner, allow_comments, nuked, nukereason, filename, save_as FROM torrents WHERE id = '.sqlesc($id)) or sqlerr(__FILE__, __LINE__);
