...
beta sat june 12th 2010 v0.1
edit post

STILL TO DO: 
- adding an attachment isn't working
- should add an attachment manage thing
...
if (!defined('BUNNY_FORUMS')) 
{
  ...
  $extension_error = $size_error = '';
	...
	//=== get the post info
	$res_post = sql_query('SELECT p.added, p.user_id AS puser_id, p.body, p.icon, p.post_title, p.bbcode, p.post_history, p.edited_by, p.edit_date, p.edit_reason, a.file,
...
if (isset($_POST['attachment_to_delete']))
{
   ...
   $attachment_to_delete = array();    
	...
	'<tr><td align="right" class="two"><span style="white-space:nowrap; font-weight: bold;">Edit By</span></td>
	<td align="left" class="two">
