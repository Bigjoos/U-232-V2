...
if (!defined('BUNNY_FORUMS')) 
{
	...
	$res_post = sql_query('SELECT p.user_id, u.id, u.class, u.suspended, t.locked, t.user_id AS owner_id, t.first_post, f.min_class_read, f.min_class_write, f.id AS forum_id 
