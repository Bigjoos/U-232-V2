...
if (!$action || $action == "show") {
    ...
    if ($count == 0) {
        ...
        while ($arr = mysql_fetch_assoc($res)) {
            ...
            <td><a href='{$INSTALLER09['baseurl']}/userdetails.php?id=$arr[uid]'>$arr[username]</a></td>
            <td>{$membertime}</td>
...
if ($action == "acceptapp") {
    ...
    $msg1 = sqlesc("User [url={$INSTALLER09['baseurl']}/userdetails.php?id=$arr[uid]][b]$arr[username][/b][/url] has been promoted to Uploader by $CURUSER[username].");
