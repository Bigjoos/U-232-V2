...
loggedinorreturn();
    ...
    $stdfoot = array(/** include js **/'js' => array('keyboard'));
    ...
    </label><br/><small>SSL (Secure Socket Layer) is a network layer security protocol which is reponsible for ensuring security of data</small></fieldset>",1);
    if(get_parked() == '1')
...
echo stdhead(htmlentities($CURUSER["username"], ENT_QUOTES)."{$lang['usercp_stdhead']} ", false) . $HTMLOUT . stdfoot($stdfoot);
