...
$res = sql_query($sql);
if(mysql_error()!=0)
$HTMLOUT .="<p>Error Deleting Event: " . mysql_error() . "<br /> Click <a class='altlink' href='{$INSTALLER09['baseurl']}/staffpanel.php?tool=events'>Here</a> to go back.<br /></p>\n";
else{
...
$res = sql_query($sql);
if(mysql_error()!=0)
$HTMLOUT .="<p>Error Saving Event: " . mysql_error() . "<br /> Click <a class='altlink' href='{$INSTALLER09['baseurl']}/staffpanel.php?tool=events'>Here</a> to go back.<br /></p>\n";
else{
if(mysql_affected_rows()==0)
