...
<font class='small'>There is approx&nbsp;".htmlspecialchars($count1)."&nbsp;peers currently</font>";
...
$sql = "SELECT p.id, p.userid, p.torrent, p.passkey, p.peer_id, p.ip, p.port, p.uploaded, p.downloaded, p.to_go, p.seeder, p.started, p.last_action, p.connectable, p.agent, p.finishedat, p.downloadoffset, p.uploadoffset, u.username, t.name ".
"FROM peers AS p ".
