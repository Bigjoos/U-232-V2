      ...
      if ($pages * $perpage < $count)
        ++$pages;
         ...
         break;
            ...
            $menu = ($page == 1? ' <div style="text-align: center; font-weight: bold;"><img src="pic/arrow_prev.gif" alt="&lt;&lt;" /> Prev' : 
                  '<a class="altlink" href="'.$url.'&amp;page='.($page - 1).$page_link.'"><img src="pic/arrow_prev.gif" alt="&lt;&lt;" /> Prev</a>').
                  '&nbsp;&nbsp;&nbsp;'.$page_num.'&nbsp;&nbsp;&nbsp;'.($page == $pages ? 'Next <img src="pic/arrow_next.gif" alt="&gt;&gt;" /> ' : 
                  ' <a class="altlink" href="'.$url.'&amp;page='.($page + 1).$page_link.'">Next <img src="pic/arrow_next.gif" alt="&gt;&gt;" /></a></div>');
