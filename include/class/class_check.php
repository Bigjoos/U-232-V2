    ...
    if ($CURUSER['class'] >= $class) {
        ...
        if ($pin) {
            ...
            if (isset($_SERVER['PHP_AUTH_USER']) && isset($_SERVER['PHP_AUTH_PW']) 
                && $_SERVER['PHP_AUTH_USER'] === ($CURUSER['username'])) {
        ...
        if ($staff) { // staff class required
            ...
            if (($CURUSER['class'] > UC_MAX) || (!isset($INSTALLER09['staff']['allowed'][$CURUSER['username']]))) { // failed: illegal access ...
                ...
                "VALUES($topicid , ".$INSTALLER09['bot_id'].", $added, $body)") or sqlerr(__file__, __line__);
                ...
                VALUES (0, ".$INSTALLER09['site']['owner'].", $added, $subject, $body)")
                    or sqlerr(__file__,__line__);
