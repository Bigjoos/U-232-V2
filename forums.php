...
$over_forum_id = $count = $child_boards = $now_viewing = '';
...
============================================================ */
  ...
  $location_bar = '<h1><a class="altlink" href="index.php">'.$INSTALLER09['site_name'].'</a>  <img src="pic/forums/arrow_next.gif" alt="&#9658;" title="&#9658;" />
  ...
  $legend = '<br /><!--<span style="text-align: center;">-->
    ...
    '<tr>
		...
		<img src="pic/forums/zip.gif" alt="Zip" title="Zip" width="18" style="vertical-align: middle;" />
		<img src="pic/forums/rar.gif" alt="Rar" title="Rar" width="18" style="vertical-align: middle;" /><br />
    ...
    <tr>		
		<td class="three" align="center" valign="middle"><img src="pic/forums/stop.png" alt="Stop" title="End time"  width="20" style="vertical-align: middle;" /></td>
    ...
    ***********************************************************************/
    ...
    $HTMLOUT .= ($arr_forums['over_forum_id'] !== $over_forum_id ? 
		...
		//=== Find last post ID
		$last_post_res = sql_query('SELECT t.id AS topic_id, t.topic_name, t.last_post, p.added, u.id, 
    ...
    $img = ($image_to_use ? 'unlockednew' : 'unlocked');
	  ...
	  '.get_date($last_post_arr['added'],'').'<br /></span>';
		...
		//=== now_viewing
		$now_viewing_res = sql_query('SELECT n_v.user_id, u.id, u.username, u.class, u.donor, u.suspended, u.warned, u.enabled, u.chatpost, u.leechwarn, u.pirate, u.king, u.avatar_rights 
    ...
    if ($now_viewing !== '')
		{
		$now_viewing = '<hr /><span style="font-size: xx-small;">now viewing:'.$now_viewing.'</span>';
		}
		.$now_viewing
		*/
...
echo stdhead($INSTALLER09['site_name'].' Forums') . $HTMLOUT;
?>