...
$HTMLOUT .= "<h1>Snatches for torrent <a href='{$INSTALLER09['baseurl']}/details.php?id=$arr[id]'>$arr[name]</a></h1>\n";
...
while ($arr = mysql_fetch_assoc($res)) {
 ...
 $completed = sprintf("%.2f%%", 100 * (1 - ($arr["to_go"] / $arr["size"])));
  ...
  $HTMLOUT .= "<tr>
  <td align='left'><a href='{$INSTALLER09['baseurl']}/userdetails.php?id=$arr[userid]'>$arr[username]</a></td>
