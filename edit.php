...
loggedinorreturn();
    ...
    $HTMLOUT  .= "<form name='edit' method='post' action='takeedit.php' enctype='multipart/form-data'>
    ...
    <tr>
    <td align='left'>
    <input type='radio' name='genre' value='keep' checked='checked' />Dont touch it [ Current: ".htmlspecialchars($row['newgenre'])." ]<br /></td>
...
//////////////////////////// HTML OUTPIT ////////////////////////////////
    print stdhead("{$lang['edit_stdhead']} '{$row["name"]}'") . $HTMLOUT . stdfoot($stdfoot);
