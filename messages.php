...
if (!$action)
{
    ...
    <tr><td align='right'><a href='{$INSTALLER09['baseurl']}/messages.php?action=editmailboxes'>Add/Edit Mailboxes</a></td></tr>
 ...
 /*
          echo("<p align='right'><input type='button' value=\"Check All\" onclick=\"this.value=check(form)\"><input type='submit' value=\"Delete selected\" /></p>");
    echo("</form>");
         */
    ...
    /////////////////// HTML OUTPUT ///////////////////////////////////////
    echo stdhead($mailbox_name, false) . $HTMLOUT . stdfoot();
    }
    ...
    if ($action == "viewmessage")
    {
      ...
      // Display message
      echo stdhead("PM ($subject)", false). $HTMLOUT . stdfoot();
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET')
    {
      ...
      <input type='submit' value='{$lang['messages_forward_btn']}' class='btn' /></td>
        ...
        echo stdhead($subject, false) . $HTMLOUT . stdfoot();
    ...
    if ($action == "editmailboxes")
    {
      ...
      if (!$res)
      {
        $HTMLOUT .= "<span style='align:center'><b>{$lang['messages_no_edit']}<b></span>";
      }
      ...
      echo stdhead("{$lang['messages_edit_mb']}s", false) . $HTMLOUT . stdfoot();
    }
